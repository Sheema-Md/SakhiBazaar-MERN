      ...
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-slate-800 p-8 rounded-3xl border border-rose-100/50 dark:border-slate-700/50 shadow-xl shadow-rose-100/30 dark:shadow-none transition-all duration-300">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-slate-400 font-medium">
            Sign in to continue to Sakhi Bazaar
          </p>
        </div>
        ...
        {error && (
          <div
            role="alert"
            className="flex items-start gap-2 bg-rose-50 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-900 text-rose-800 dark:text-rose-300 p-3 rounded-2xl text-sm"
          >
        ...
        {success && (
          <div
            role="status"
            className="flex items-start gap-2 bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-900 text-emerald-800 dark:text-emerald-300 p-3 rounded-2xl text-sm"
          >
        ...
        >
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2.5 bg-slate-50 dark:bg-slate-900 border border-gray-300 dark:border-slate-700 rounded-xl text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500 text-sm disabled:opacity-60"
          ...
          <div className="space-y-3">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="w-full flex justify-center items-center py-3 px-4 border border-transparent text-sm font-bold rounded-xl text-white bg-linear-to-r from-rose-500 to-indigo-650 hover:from-rose-600 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500 shadow-md shadow-rose-200 dark:shadow-none transition-all duration-300 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
            >
